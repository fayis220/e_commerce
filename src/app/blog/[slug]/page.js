            ...
            <div className="row">
              ...
              <div className="col-lg-9">
                <div className="blog-details-right">
                  <div className="blog-details-img" data-aos="zoom-in" data-aos-delay="100"
                    data-aos-duration="1500">
                    <Link href="" className="img-cover">  <Image src={pageData.image ? pageData.image : themeConfig.no_found_image} width={945} height={444} alt="" /> </Link>
                  </div>
                  <div className="blog-details-right-wrapper">
                    ...
                    <div className="blog-time-date">
                      <div className="blog-time">
                        <p><i className="far fa-clock"></i>{pageData.date}</p>
                      </div>
                      <div className="blog-user">
                        <p><i className="fas fa-user"></i>{pageData.username}</p>
                      </div>
                    </div>
                    <p>
                      {pageData.label}
                    ...
                    <div className="latest-fashion-trend">
                      <div className="row align-items-center">
                        <div className="col-md-6 pr-3 pr-md-0">
                          <div className="latest-fashion-img" data-aos="zoom-in" data-aos-delay="200"
                            data-aos-duration="1500">
                            <Link href="" className="img-cover"> <Image src={pageData.blog_left_image ? pageData.blog_left_image : themeConfig.no_found_image} width={464} height={320}
                              alt="" /> </Link>
                          </div>
                        </div>
                    ...
                    <div className="latest-fashion-trend">
                      <div className="row align-items-center">
                        ...
                        <div className="col-md-6 pl-3 pl-md-0 order-first order-md-last">
                          <div className="latest-fashion-img" data-aos="zoom-in" data-aos-delay="300"
                            data-aos-duration="1500">
                            <Link href="" className="img-cover">
                              <Image src={pageData.blog_right_image ? pageData.blog_right_image : themeConfig.no_found_image}
                                width={464}
                                height={320}
                                alt="" /> </Link>
                          </div>
                      ...
                      <div className="latest-fashion-categories-wrap">
                        <ul>
                          {pageData.latest_fashion_categories &&
                            ...
                            ?
                            pageData.latest_fashion_categories.map((list_data, index) =>
                            (
                              <li key={index}><Link href="/gallery">{list_data}</Link></li>
                    ...
                    <div className="what-to-expext">
                      ...
                      <p>
                        {pageData.what_to_label}
                      </p>
                      <div className="expext-list">
                        <ul>
                          {pageData.expext_list && pageData.expext_list.length > 0 ? pageData.expext_list.map((list_data, index) => (
                    ...
                    <div className="leave-comments">
                      ...
                      <div className="form-details" data-aos="fade-up" data-aos-delay="100"
                        data-aos-duration="1500">
                          ...
                          <div className="form-row">
                            <div className="form-group col-md-6">
                              <input
                                ...
                                onFocus={handleFocus}
                              />
                              {errors.fullName && <div className="error text-danger">{errors.fullName.message}</div>}
                            </div>
                            <div className="form-group col-md-6">
                              <input
                                type="email"
                          ...
                          <div className="form-row">
                            <div className="form-group col-md-6">
                              <input
                                ...
                                onFocus={handleFocus}
                              />
                              {errors.phone && <div className="error text-danger">{errors.phone.message}</div>}
                            </div>
                          </div>

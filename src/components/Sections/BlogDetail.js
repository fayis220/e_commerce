                                ...
                                <div className="blog-details-right">
                                    <div className="blog-details-img" data-aos="zoom-in" data-aos-delay="100"
                                        ...
                                        <Link href="" className="img-cover">
                                            <Image src={data.image ? data.image : themeConfig.no_found_image} width={945} height={444} alt="" />
                                        </Link>
                                    </div>
                                    <div className="blog-details-right-wrapper">
                                        ...
                                        <div className="blog-time-date">
                                            ...
                                            <div className="blog-user">
                                                <p><i className="fas fa-user"></i>{data.username}</p>
                                            </div>
                                        </div>
                                        <p>{data.label}</p>
                                        <p>{data.detail}</p>
                                            ...
                                            <div className="row align-items-center">
                                                <div className="col-md-6 pr-3 pr-md-0">
                                                    <div className="latest-fashion-img" data-aos="zoom-in" data-aos-delay="200"
                                                        data-aos-duration="1500">
                                                        <Link href="" className="img-cover">
                                                            <Image src={data.blog_left_image ? data.blog_left_image : themeConfig.no_found_image}
                                                                width={464}
                                                                height={320}
                                                                alt="" />
                                                        </Link>
                                            ...
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-md-6 pl-3 pl-md-0 order-first order-md-last">
                                                    <div className="latest-fashion-img" data-aos="zoom-in" data-aos-delay="300"
                                                        data-aos-duration="1500">
                                                        <Link href="" className="img-cover">
                                                            <Image src={data.blog_right_image ? data.blog_right_image : themeConfig.no_found_image} width={464} height={320}
                                                                alt="" />
                                                        </Link>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="latest-fashion-categories-wrap">
                                                <ul>
                                                    {data.latest_fashion_categories &&
                                                        ...
                                                        ?
                                                        data.latest_fashion_categories.map((list_data, index) => (
                                        ...
                                        <div className="what-to-expext">
                                            ...
                                            <div className="expext-list">
                                                <ul>
                                                    {data.expext_list && data.expext_list.length > 0 ? data.expext_list.map((list_data, index) => (
